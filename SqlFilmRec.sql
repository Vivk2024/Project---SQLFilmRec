...
SELECT * FROM MOVIE;
SELECT
SUM(IF(id IS NULL, 1, 0)) AS ID_nulls,
SUM(IF(title IS NULL, 1 ,0)) AS ID_nulls,
SUM(IF(year IS NULL, 1, 0)) AS ID_nulls,
SUM(IF(date_published IS NULL, 1, 0)) AS ID_nulls,
SUM(IF(country IS NULL, 1, 0)) AS ID_nulls,
SUM(IF(worlwide_gross_income IS NULL, 1, 0)) AS ID_nulls,
SUM(IF(languages IS NULL, 1, 0)) AS ID_nulls,
SUM(IF(product_conpany IS NULL, 1, 0)) AS ID_nulls
